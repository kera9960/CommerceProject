...
public class CommerceSystem {
    ...
    private ProcessOrder po = new ProcessOrder(cart);
    ...
    public void start() {
        ...
        do {
            ...
            categoryChoice = checker.minMax(sc,0,5);
            if (cart.isEmpty() && (categoryChoice == 4 || categoryChoice == 5)) {
            ...
            if (categoryChoice == 0) {
                ...
                int orderConfirmed = checker.minMax(sc,1,2);
                if (orderConfirmed == 1) {
                    po.confirmPurchase();
                ...
                int cancel = checker.minMax(sc,1,2);
                if (cancel == 1){
                    po.cancelOrder();
                } else if (cancel == 2) {
                    System.out.println("메인으로 돌아갑니다.");
            ...
            while (true) {
                ...
                int productChoice = checker.minMax(sc,0,selectProducts.size());
                if (productChoice == 0) {
                    break;
                }
                ...
                int inCart = checker.minMax(sc,1,2);
                if (inCart == 1){
